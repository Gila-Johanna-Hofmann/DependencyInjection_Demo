...
namespace DependencyInjection_Demo
{
    ...
    {
        /// <summary>
        /// The usage of IHost here is optional. You could also use a IServiceProvider with an instance of ServiceCollection to act as the Dependency Injection container
